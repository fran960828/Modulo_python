...
- Explicación y creación de una clase de formulario de registro que hereda de form con uso de metodos para verificar si la contraseña es igual a repetir contraseña y si es valida.
- Explicación y uso de la clase form en la view y renderizado en un template.
